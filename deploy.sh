...
scripts_s3_bucket="mbiakop" # bucket must exist in the SAME region the deployment is taking place
backups_s3_bucket="codecommit-ackup" # bucket must exist and have no policy that disallows PutObject from CodeBuild
stack_name="codecommit-backups-us-east-1"
